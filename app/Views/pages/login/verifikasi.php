...
<body>
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form action="/login/update_verifikasi" class="login100-form validate-form daftar" method="POST">
                    <span class="login100-form-title">
                        Verifikasi Kode
                    </span>

                    <div class="wrap-input100 validate-input" data-validate="Kode Harus Diisi">
                        <input type="hidden" value="<?= $kode[0]['id'] ?>" name="id">
                    ...
                    <div class="text-center p-t-12">
                        <a class="txt2" href="<?= base_url('login/kirim_ulang_verifikasi/' . $kode[0]['id'] . '/' . $kode[0]['username'] . '/' . $kode[0]['email']); ?>">
                            Kirim Ulang Kode
                        </a><br>
    ...
    <script>
        ...
        if (flashdata == 'Pendaftaran Berhasil, Silahkan Cek Email untuk Verifikasi') {
            Swal.fire(
                'Berhasil!',
                flashdata,
                'success'
        ...
        if (flashdata == 'Verifikasi Gagal, Kode yang Anda Masukan Salah') {
            Swal.fire(
                'Gagal!',
                flashdata,
                'error'
        ...
        if (flashdata == 'Mengirim Ulang Berhasil, Silahkan cek kembali email anda') {
            Swal.fire(
                'Berhasil!',
                flashdata,
                'success'
