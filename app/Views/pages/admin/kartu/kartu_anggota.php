...
$nama = $kartu['username'] . '-' . $kartu['nama'] . '-' . $kartu['jabatan'] . '-' . $kartu['angkatan'];
$tempdir = 'plugins/phpqrcode/temp/';
$logopath = 'dist/img/icon.png';
$codeContents = $kartu['username'] . '-' . $kartu['password'] . '-' . $kartu['nama'] . '-' . $kartu['jabatan'] . '-' . $kartu['angkatan'];
...
<div class="kartu">
    ...
    <h3 align="center" style="line-height:0px; margin-top:0;">' . $kartu['jabatan'] . '</h3><br><br>
    <div style="width:35%; padding:8px; margin:0% 32%; border-radius:20px; background:lightblue; box-shadow: 5px 5px #000;">
        <h3 align="center" style="font-size:20px; font-weight:bold; line-height:0; margin-top:0px;">' . $kartu['angkatan'] . '</h3>
    </div>
</div>
<div class="kartu">
...
$html2pdf->Output('Kartu_Anggota_' . $kartu['nama'] . '.pdf');
exit();
