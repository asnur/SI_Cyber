            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" action="/admin/save_tambah_anggota" method="POST" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                ...
                                <input type="number" name="no_tlp" placeholder="Masukan No Hp" class="form-control">
