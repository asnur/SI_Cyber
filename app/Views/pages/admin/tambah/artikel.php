                            ...
                            <form action="/admin/save_tambah_artikel" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card card-outline card-info">
                                    ...
                                    <div class="card-body pad">
                                        <div class="mb-3">
                                            <textarea name="isi" class="textarea <?= ($validation->hasError('isi')) ? 'is-invalid' : ''; ?>" placeholder="Place some text here" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                            <div class="invalid-feedback">
